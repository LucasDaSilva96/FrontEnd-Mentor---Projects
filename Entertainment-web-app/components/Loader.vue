...
<template>
  <div v-if="props.isLoading"
    class="fixed top-0 left-0 z-50 w-full h-full bg-black/50 flex items-center justify-center backdrop-blur-sm">
    <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 24 24">
      <rect width="10" height="10" x="1" y="1" fill="#FC4747" rx="1">
      ...
      <rect width="10" height="10" x="1" y="13" fill="#FC4747" rx="1">
      ...
      <rect width="10" height="10" x="13" y="13" fill="#FC4747" rx="1">
